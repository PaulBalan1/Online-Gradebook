...
namespace WebApplication.Data
{
    public class SecretaryService : ISecretaryService
    {
        ...
        {
            string URI = "http://localhost:" + Startup.PORT +
                         $"/secretary/addstudent?classNr={classNr}&classLetter={classLetter}&studentId={studentId}";
            return await GetRequest(URI);
        }
        ...
        {
            string URI = "http://localhost:" + Startup.PORT +
                         $"/secretary/removestudent?classNr={classNr}&classLetter={classLetter}&studentId={studentId}";
            return await GetRequest(URI);
        }
        ...
        {
            string URI = "http://localhost:" + Startup.PORT +
                         $"/secretary/addcourse?classNr={classNr}&classLetter={classLetter}&courseName={courseName}";
            return await GetRequest(URI);
        }
        ...
        {
            string URI = "http://localhost:" + Startup.PORT +
                         $"/secretary/removecourse?classNr={classNr}&classLetter={classLetter}&courseName={courseName}";
            return await GetRequest(URI);
        }
